  ...
  titles: MoscowColumnTitle[] = [
    {
      ...
      infoHighlight: 'Kies welke contributie het kind kan doen per leeftijdscategorie',
      infoText:
        'Je kiest op deze pagina welke bijdrage(n) kinderen kunnen leveren aan het portfolio per leeftijdscategorie. Sommige onderdelen zijn wellicht minder relevant voor jongere leerlingen. De eisen kunnen hier worden gewijzigd naar eigen inzicht.',
    },
    {
      title: 'Ontwikkeling',
      hasSubtitle: true,
