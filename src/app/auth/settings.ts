...
export default class Settings {
  ...
  public static authSections: AuthSection[] = [
    {
      id: 'information',
      step: 1,
      steps: 4,
      title: 'Achtergrond',
      color: 'is-warning',
      nextPageButtonText: 'Naar onderzoeken en verdiepen',
      currentPage: '/auth/information',
      previousPage: null,
    ...
    },
    {
      ...
      color: 'is-link',
      nextPageButtonText: 'Naar set van eisen',
      currentPage: '/auth/choices',
    ...
    },
    {
      ...
      title: 'Set van eisen',
      color: 'is-primary',
      nextPageButtonText: 'Naar overzicht',
      currentPage: '/auth/requirements',
    ...
    },
    {
      ...
      color: 'is-success',
      nextPageButtonText: 'Sessie afsluiten',
      currentPage: '/auth/overview',
